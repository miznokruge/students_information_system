		...
		<form action="./index.html" method="post">
			...
			<div class="login-fields">
				...
				<div class="field">
					...
					<input id="username" name="username" value="" placeholder="Username" class="form-control input-lg username-field" type="text">
				</div> <!-- /field -->
				
				<div class="field">
					<label for="password">Password:</label>
					<input id="password" name="password" value="" placeholder="Password" class="form-control input-lg password-field" type="password">
				</div> <!-- /password -->
