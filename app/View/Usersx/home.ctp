                    ...
                    <div class="widget-body widget-hide-overflow no-padding">
                        ...
                        <div id="chat-container">
                            ...
                            <div class="chat-list-body custom-scroll">
                                <ul id="chat-users">
                                    <li>
                                        <a href="javascript:void(0);"><img src="img/avatars/5.html">Robin Berry <span class="badge badge-inverse">23</span><span class="state"><i class="fa fa-circle txt-color-green pull-right"></i></span></a>
                                    </li>
                                    <li>
                                        <a href="javascript:void(0);"><img src="img/avatars/male.html">Mark Zeukartech <span class="state"><i class="last-online pull-right">2hrs</i></span></a>
                                    </li>
                                    <li>
                                        <a href="javascript:void(0);"><img src="img/avatars/male.html">Belmain Dolson <span class="state"><i class="last-online pull-right">45m</i></span></a>
                                    </li>
                                    <li>
                                        <a href="javascript:void(0);"><img src="img/avatars/male.html">Galvitch Drewbery <span class="state"><i class="fa fa-circle txt-color-green pull-right"></i></span></a>
                                    </li>
                                    <li>
                                        <a href="javascript:void(0);"><img src="img/avatars/male.html">Sadi Orlaf <span class="state"><i class="fa fa-circle txt-color-green pull-right"></i></span></a>
                                    </li>
                                    <li>
                                        <a href="javascript:void(0);"><img src="img/avatars/male.html">Markus <span class="state"><i class="last-online pull-right">2m</i></span> </a>
                                    </li>
                                    <li>
                                        <a href="javascript:void(0);"><img src="img/avatars/sunny.html">Sunny <span class="state"><i class="last-online pull-right">2m</i></span> </a>
                                    </li>
                                    <li>
                                        <a href="javascript:void(0);"><img src="img/avatars/male.html">Denmark <span class="state"><i class="last-online pull-right">2m</i></span> </a>
                                    </li>
                                </ul>
                            </div>
                        ...
                        <div id="chat-body" class="chat-body custom-scroll">
                            <ul>
                                <li class="message">
                                    <img src="img/avatars/5.html" class="online">
                                ...
                                <li class="message">
                                    <img src="img/avatars/sunny.html" class="online">
                                    <span class="message-text">
                                        <time>
                                            12:23pm
...
<script type="text/javascript">
    ...
    loadScript("<?php echo $this->webroot; ?>js/plugin/flot/jquery.flot.cust.html", loadFlotResize);

    function loadFlotResize() {
        loadScript("<?php echo $this->webroot; ?>js/plugin/flot/jquery.flot.resize.html", loadFlotToolTip);
    }

    function loadFlotToolTip() {
        loadScript("<?php echo $this->webroot; ?>js/plugin/flot/jquery.flot.tooltip.html", generatePageGraphs);
    }
    ...
    loadScript("<?php echo $this->webroot; ?>js/plugin/vectormap/jquery-jvectormap-1.2.2.min.html", loadMapFile);

    // Load Map dependency 2 then rendeder Map
    function loadMapFile() {
        loadScript("<?php echo $this->webroot; ?>js/plugin/vectormap/jquery-jvectormap-world-mill-en.html", renderVectorMap);
    }
    ...
    loadScript("<?php echo $this->webroot; ?>js/plugin/fullcalendar/jquery.fullcalendar.min.html", setupCalendar);
