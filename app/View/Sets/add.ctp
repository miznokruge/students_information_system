    ...
    <div class="col-md-10">
        <div class="sets form">
            ...
            <fieldset>
                ...
                echo $this->Form->input('answeron', array("class" => 'form-control col-md-3'));
                echo $this->Form->input('category_id');
                echo $this->Form->input('creator');
                echo $this->Form->input('password');
                echo $this->Form->input('isopen', array("type" => "select", "class" => "form-control col-md-4", "options" => array('0' => 'N', '1' => 'Y')));
