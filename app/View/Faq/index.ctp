<div class="row">
            ...
            <div class="widget-content">
                ...
                <div class="faq-container">
                    <!--                    <form class="faq-search">
                                            <input type="text" class="form-control" name="search" placeholder="Search by Keyword"></form>-->
                    <ol class="faq-list">
                        <?php
                        $no = 1;
                        foreach ($faqs as $faq):
                            ...
                            <li id="faq-1">
                                <div class="faq-icon">
                                    <div class="faq-number"><?php //echo $no;      ?></div></div>
                                <div class="faq-text">
    ...
    <div class="col-md-4">
        <div class="widget widget-plain">
            <div class="widget-content">
                <?php echo $this->Html->link(__('Ask A Question'), array(), array('class' => 'btn btn-primary btn-support-ask')); ?>
