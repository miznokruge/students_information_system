<div class="statistics index row">
    <div class="col-md-10">
        <h3 class="index-title"><?php echo __('Statistics'); ?></h3>
        <?php echo $this->Form->create('Statistic', array('type' => 'get', 'style' => 'margin:5px auto;', 'action' => 'index')); ?>        <div class="input-group custom-search-form">
            ...
            <span class="input-group-btn" style="margin: auto 5px;">
                <?php echo $this->Html->link('<i class="icon icon-refresh"></i> View All', array('controller' => 'Statistics', 'action' => 'index'), array('class' => 'btn btn-default', 'escape' => false)); ?>            </span>
        </div>
        <?php echo $this->Form->end(); ?>        <table class="table table-striped table-bordered table-responsive">
            <tr>
                ...
                <th><?php echo $this->Paginator->sort('score', 'Right'); ?></th>
                <th><?php echo $this->Paginator->sort('totalscore', 'totalscore(%)'); ?></th>
                <th><?php echo $this->Paginator->sort('rquestions'); ?></th>
                <th><?php echo $this->Paginator->sort('wquestions'); ?></th>
            ...
            <?php foreach ($statistics as $statistic): ?>
                <tr>
                    ...
                    <td>
                        <?php echo $this->Html->link($statistic['User']['username'], array('controller' => 'users', 'action' => 'view', $statistic['User']['id'])); ?>
                    </td>
                    <td><?php echo h($statistic['Statistic']['score']); ?>&nbsp;</td>
                    <td><?php echo h($statistic['Statistic']['totalscore']); ?>&nbsp;</td>
                    <td><?php echo h($statistic['Statistic']['rquestions']); ?>&nbsp;</td>
                    <td><?php echo h($statistic['Statistic']['wquestions']); ?>&nbsp;</td>
                    ...
                    <td class="actions">
                        <div class="btn-group">
                            ...
                            <ul class="dropdown-menu" role="menu">			<li><?php echo $this->Html->link(__('<i class="icon-zoom-in"></i> View'), array('action' => 'view', $statistic['Statistic']['id']), array('escape' => false, 'class' => 'ui-popover', 'data-container' => 'body', 'data-toggle' => 'popover', 'data-trigger' => 'hover', 'data-placement' => 'top', 'data-content' => 'Click to view the details of this record.', 'title' => '', 'data-original-title' => 'Information')); ?></li>
                                <li><?php echo $this->Html->link(__('<i class="icon-edit"></i> Edit'), array('action' => 'edit', $statistic['Statistic']['id']), array('escape' => false, 'class' => 'ui-popover', 'data-container' => 'body', 'data-toggle' => 'popover', 'data-trigger' => 'hover', 'data-placement' => 'top', 'data-content' => 'Click to edit this record.', 'title' => '', 'data-original-title' => 'Information')); ?></li>
                                <li><?php echo $this->Form->postLink(__('<i class="icon-trash"></i> Delete'), array('action' => 'delete', $statistic['Statistic']['id']), array('escape' => false, 'class' => 'ui-popover', 'data-container' => 'body', 'data-toggle' => 'popover', 'data-trigger' => 'hover', 'data-placement' => 'top', 'data-content' => 'Click to delete this record.', 'title' => '', 'data-original-title' => 'Information'), __('Are you sure you want to delete # %s?', $statistic['Statistic']['id'])); ?></li>
                            </ul>
                        </div>		</td>
                </tr>
            <?php endforeach; ?>
