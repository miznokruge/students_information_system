<div class="studentEvents index">
	<h2><?php echo __('Student Events'); ?></h2>
	...
	<tr>
		...
		<td class="actions">
			<?php echo $this->Html->link(__('View'), array('action' => 'view', $studentEvent['StudentEvent']['id'])); ?>
			<?php echo $this->Html->link(__('Edit'), array('action' => 'edit', $studentEvent['StudentEvent']['id'])); ?>
			<?php echo $this->Form->postLink(__('Delete'), array('action' => 'delete', $studentEvent['StudentEvent']['id']), array(), __('Are you sure you want to delete # %s?', $studentEvent['StudentEvent']['id'])); ?>
		</td>
	</tr>
<?php endforeach; ?>
	</tbody>
