    ...
    <?php echo $this->Session->flash(); ?>
        ...
        <div class="widget stacked">
            <div class="widget-header">
                <span class="pull-left"><?php echo __('Update Profile'); ?></span>
            ...
            <div class="widget-content" id="register">
                <div class="widget-content_left">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-8" ><?php echo $this->Form->input("username", array('label' => false, 'div' => false, 'class' => "umstyle5")) ?></div>
                        
                    </div>
                    <div class="form-group">
                        <div class="col-md-4"><?php echo __('First Name'); ?><font color='red'>*</font></div>
                        <div class="col-md-8" ><?php echo $this->Form->input("first_name", array('label' => false, 'div' => false, 'class' => "umstyle5")) ?></div>
                        
                    </div>
                    <div class="form-group">
                        <div class="col-md-4"><?php echo __('Last Name'); ?><font color='red'>*</font></div>
                        <div class="col-md-8" ><?php echo $this->Form->input("last_name", array('label' => false, 'div' => false, 'class' => "umstyle5")) ?></div>
                        
                    </div>
                    <div class="form-group">
                        <div class="col-md-4"><?php echo __('Email'); ?><font color='red'>*</font></div>
                        <div class="col-md-8" ><?php echo $this->Form->input("email", array('label' => false, 'div' => false, 'class' => "umstyle5")) ?></div>
