        ...
        <div class="widget-content" id="forgot">
            <div class="widget-content_left">
                ...
                <div class="form-group">
                    <div class="col-md-10" >
                        <?php echo $this->Form->input("email", array('label' => false, 'div' => false, 'class' => "form-control", 'placeholder' => __('Enter Email / Username'))) ?>

                    </div>
                    <div class="col-md-2">
                        <?php echo $this->Form->Submit(__('Send Email'), array('class' => 'btn btn-lg btn-primary')); ?>
                    </div>
